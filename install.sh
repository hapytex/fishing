...
stack update &
pip3 install --upgrade black Click isort jinja2-cli jupyter keras nltk numpy pandas pip prefect pygments scipy sklearn sympy tabulate tensorflow thefuck youtube-dl &
