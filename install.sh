...
sudo apt-get install apt-file cloc curl djinn fish git hlint hoogle lambdabot nodejs npm pandoc pdfsam powerline rename ulimit yarn

git config --global push.default current

pip3 install --upgrade black numpy pandas scipy sympy
