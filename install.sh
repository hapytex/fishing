...
stack update &
pip3 install --upgrade black Click dateparser isort jinja2-cli jupyter keras nltk numpy pandas pip prefect pygments scipy scikit-learn sympy tabulate tensorflow thefuck youtube-dl &
